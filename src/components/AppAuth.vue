        ...
        <div class="py-4 text-left px-6">
          ...
          >
            ...
            <div class="mb-3">
              ...
              />
              <!-- O nome do componente aqui tem que ser o nome do que vai ser validado -->
...
<script>
//mapState só lê, mapWritableState lê e altera
...
export default {
  ...
  methods: {
    register(values) {
      ...
      (this.reg_alert_msg = 'Sucess! Your account has being created.')),
        console.log(values))
    },
  },
}
